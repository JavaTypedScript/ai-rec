            ...
            {!selectedProjectId ? (
              ...
              <form onSubmit={handleGetRecommendations} className="space-y-4">
                <h3 className="text-lg font-semibold">
                  Project: <span className="text-blue-600">{selectedProject.project_name}</span>
                </h3>
                <p className="text-sm text-gray-600">
                  Model Type: <span className="font-medium uppercase text-gray-800">{selectedProject.model_type}</span>
                </p>
            ...
            {projects.map(p => (
              <li
                ...
                className={`p-4 border rounded-md cursor-pointer ${
                  selectedProjectId === p.id ? 'bg-blue-50 border-blue-400 shadow-sm' : 'hover:bg-gray-50 border-gray-200'
                }`}
              >
